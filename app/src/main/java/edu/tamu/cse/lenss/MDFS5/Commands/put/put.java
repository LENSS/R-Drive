...
public class put {
    ...
    private static String sendFile(String filename, File file, String filePathMDFS){
        ...
        MDFSFileCreatorViaRsockNG curFile = new MDFSFileCreatorViaRsockNG(file, filePathMDFS, maxBlockSize, Constants.K_N_RATIO, ServiceHelper.fetchInstance().getEncryptKey());
