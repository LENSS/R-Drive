package edu.tamu.cse.lenss.MDFS5.Commands.get;
...
import edu.tamu.cse.lenss.MDFS5.Model.MDFSRsockBlockForFileRetrieve;
import edu.tamu.cse.lenss.MDFS5.ReedSolomon.DeCoDeR;
...
public class FileMerge implements Runnable{
    ...
    private void decodeBlockFile(List<FragmentInfo> blockFragments, int blockIdx){
        ...
        if (ServiceHelper.fetchInstance().getEncryptKey() == null) {
            //log and listener
        ...
        //make decoder object
        DeCoDeR decoder = new DeCoDeR(ServiceHelper.fetchInstance().getEncryptKey(), mdfsrsockblock.n2, mdfsrsockblock.k2, blockFragments, tmp.getAbsolutePath());
