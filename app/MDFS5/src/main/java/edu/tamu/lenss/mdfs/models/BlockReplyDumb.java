...
public class BlockReplyDumb {
    ...
    public BlockReplyDumb(String name, long time, byte blockIndex, String source, String destination){ //source = who is sending back the reply  | destination  = who originally made the request
        this.fileName = name;
