...
public class MDFSRsockBlockForFileCreate implements Serializable {
	...
	public String uniqueReqID;		//unique uuid using which this file metadata is identified
	public boolean isGlobal;        //is this file globally accessible or nah


	public MDFSRsockBlockForFileCreate(String filename, String filePathMDFS, byte[] filefrag, long filecreatedtime, long entirefilesize, byte n2, byte k2, byte blockidx, byte fragmentidx, String filecreatorguid, String uniquereqid, boolean isglobal){
