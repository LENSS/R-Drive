...
public class FileMetadata implements Serializable {
    ...
    public String toBuffer(edu.tamu.lenss.mdfs.EdgeKeeper.FileMetadata metadata){
    ...
    public static edu.tamu.lenss.mdfs.EdgeKeeper.FileMetadata parse(String incoming){

        ObjectMapper Obj = new ObjectMapper();
        edu.tamu.lenss.mdfs.EdgeKeeper.FileMetadata metadata = null;
        try {
            metadata = Obj.readValue(incoming, edu.tamu.lenss.mdfs.EdgeKeeper.FileMetadata.class);
