...
public class MDFSRsockBlockForFileRetrieve implements Serializable {
    ...
    //request constructor
    public MDFSRsockBlockForFileRetrieve(FragmentTransferInfo header, String destGUID, String srcGUID, String filename, long fileid, byte blockidx, byte fragmentindex){  //srcGUID = requester sender GUID |  destGUID = requester receiver GUID
    ...
    //reply constructor
    public MDFSRsockBlockForFileRetrieve(byte[] filefrag, int fraglength, boolean fileSuccess, String myGUID){
