...
public class MDFSRsockBlockForFileRetrieveNG implements Serializable {
    ...
    private MDFSRsockBlockForFileRetrieveNG(){}

    //only public constructor
    public MDFSRsockBlockForFileRetrieveNG(Type type, byte n2, byte k2, String srcGUID, String destGUID, String fileName, long fileId, byte totalNumOfBlocks , byte blockIdx, byte fragmentIndex, String locDir, byte[] fileFrag){
        this.type = type;
        this.n2 = n2;
        this.k2 = k2;
