...
public class MDFSFragmentForFileCreate implements Serializable {
	...
	public MDFSFragmentForFileCreate(String filename, String filePathMDFS, byte[] filefrag, String fileID, long entirefilesize, int n2, int k2, int blockidx, int fragmentidx, String filecreatorguid, String uniquereqid, int totalNumOfBlocks,  boolean isglobal){
