...
public class MDFSRsockBlockForFileCreate implements Serializable {
	...
	public MDFSRsockBlockForFileCreate(String filename, String filePathMDFS, byte[] filefrag, String fileID, long entirefilesize, int n2, int k2, int blockidx, int fragmentidx, String filecreatorguid, String uniquereqid, boolean isglobal){
